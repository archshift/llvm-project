...
// CHECK-LABEL: define i64 @test_mm512_reduce_max_epi64(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i64 @test_mm512_reduce_max_epu64(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I7_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__B_ADDR_I8_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__A_ADDR_I5_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define double @test_mm512_reduce_max_pd(<8 x double> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i64 @test_mm512_reduce_min_epi64(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I7_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__B_ADDR_I8_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__A_ADDR_I5_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define i64 @test_mm512_reduce_min_epu64(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I7_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__B_ADDR_I8_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__A_ADDR_I5_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define double @test_mm512_reduce_min_pd(<8 x double> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I8_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__B_ADDR_I9_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__A_ADDR_I_I:%.*]] = alloca <2 x double>, align 16
...
// CHECK-LABEL: define i64 @test_mm512_mask_reduce_max_epi64(i8 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i64 @test_mm512_mask_reduce_max_epu64(i8 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define double @test_mm512_mask_reduce_max_pd(i8 noundef zeroext %__M, <8 x double> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i64 @test_mm512_mask_reduce_min_epi64(i8 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__D_ADDR_I_I:%.*]] = alloca i64, align 8
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define i64 @test_mm512_mask_reduce_min_epu64(i8 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__D_ADDR_I_I:%.*]] = alloca i64, align 8
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define double @test_mm512_mask_reduce_min_pd(i8 noundef zeroext %__M, <8 x double> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca double, align 8
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <8 x double>, align 64
// CHECK-NEXT:    [[__W2_ADDR_I_I:%.*]] = alloca <8 x double>, align 64
...
// CHECK-LABEL: define i32 @test_mm512_reduce_max_epi32(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i32 @test_mm512_reduce_max_epu32(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__V1_ADDR_I12_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I13_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I10_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-LABEL: define float @test_mm512_reduce_max_ps(<16 x float> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i32 @test_mm512_reduce_min_epi32(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__V1_ADDR_I12_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I13_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I10_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-LABEL: define i32 @test_mm512_reduce_min_epu32(<8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__V1_ADDR_I12_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I13_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I10_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-LABEL: define float @test_mm512_reduce_min_ps(<16 x float> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I12_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__B_ADDR_I13_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__A_ADDR_I10_I:%.*]] = alloca <4 x float>, align 16
...
// CHECK-LABEL: define i32 @test_mm512_mask_reduce_max_epi32(i16 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i32 @test_mm512_mask_reduce_max_epu32(i16 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__U_ADDR_I_I:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__A_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define float @test_mm512_mask_reduce_max_ps(i16 noundef zeroext %__M, <16 x float> noundef %__W) #0 {
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: define i32 @test_mm512_mask_reduce_min_epi32(i16 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S_ADDR_I_I:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <16 x i32>, align 64
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define i32 @test_mm512_mask_reduce_min_epu32(i16 noundef zeroext %__M, <8 x i64> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__S_ADDR_I_I:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <16 x i32>, align 64
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
...
// CHECK-LABEL: define float @test_mm512_mask_reduce_min_ps(i16 noundef zeroext %__M, <16 x float> noundef %__W) #0 {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__W_ADDR_I_I:%.*]] = alloca float, align 4
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I:%.*]] = alloca <16 x float>, align 64
// CHECK-NEXT:    [[__W2_ADDR_I_I:%.*]] = alloca <16 x float>, align 64
