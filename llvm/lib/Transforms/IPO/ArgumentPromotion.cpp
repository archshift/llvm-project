...
doPromotion(Function *F, SmallPtrSetImpl<Argument *> &ArgsToPromote,
  ...
  // The attribute list we'll use for promoted arguments. We mark them
  // PartialInit because there's no way of knowing the data's initialization
  // state on the other side of a pointer or reference.
