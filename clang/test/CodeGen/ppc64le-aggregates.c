...
// CHECK: define partialinit [1 x <4 x float>] @func_v3f1(<3 x float> inreg partialinit %x.coerce)
struct v3f1 func_v3f1(struct v3f1 x) { return x; }

// CHECK: define partialinit [2 x <4 x float>] @func_v3f2([2 x <4 x float>] partialinit %x.coerce)
struct v3f2 func_v3f2(struct v3f2 x) { return x; }

// CHECK: define partialinit [3 x <4 x float>] @func_v3f3([3 x <4 x float>] partialinit %x.coerce)
struct v3f3 func_v3f3(struct v3f3 x) { return x; }

// CHECK: define partialinit [4 x <4 x float>] @func_v3f4([4 x <4 x float>] partialinit %x.coerce)
struct v3f4 func_v3f4(struct v3f4 x) { return x; }

// CHECK: define partialinit [5 x <4 x float>] @func_v3f5([5 x <4 x float>] partialinit %x.coerce)
struct v3f5 func_v3f5(struct v3f5 x) { return x; }

// CHECK: define partialinit [6 x <4 x float>] @func_v3f6([6 x <4 x float>] partialinit %x.coerce)
struct v3f6 func_v3f6(struct v3f6 x) { return x; }

// CHECK: define partialinit [7 x <4 x float>] @func_v3f7([7 x <4 x float>] partialinit %x.coerce)
struct v3f7 func_v3f7(struct v3f7 x) { return x; }

// CHECK: define partialinit [8 x <4 x float>] @func_v3f8([8 x <4 x float>] partialinit %x.coerce)
...
// CHECK: define partialinit [2 x <4 x float>] @func_v3fab([2 x <4 x float>] partialinit %x.coerce)
struct v3fab func_v3fab(struct v3fab x) { return x; }

// CHECK: define partialinit [3 x <4 x float>] @func_v3fabc([3 x <4 x float>] partialinit %x.coerce)
...
// CHECK: call partialinit [1 x <4 x float>] @func_v3f1(<3 x float> inreg partialinit %[[TMP]])
...
// CHECK: call partialinit [2 x <4 x float>] @func_v3f2([2 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [3 x <4 x float>] @func_v3f3([3 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [4 x <4 x float>] @func_v3f4([4 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [5 x <4 x float>] @func_v3f5([5 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [6 x <4 x float>] @func_v3f6([6 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [7 x <4 x float>] @func_v3f7([7 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [8 x <4 x float>] @func_v3f8([8 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [2 x <4 x float>] @func_v3fab([2 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: call partialinit [3 x <4 x float>] @func_v3fabc([3 x <4 x float>] partialinit %[[TMP]])
...
// CHECK: define partialinit { i64, i64 } @ret_s9()
struct s9 ret_s9() {
