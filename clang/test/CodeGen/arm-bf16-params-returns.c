...
// CHECK32-SOFTFP: define noundef bfloat @test_ret_bf16(bfloat noundef returned %v) {{.*}} {
// CHECK32-SOFTFP: ret bfloat %v
// CHECK64: define noundef bfloat @test_ret_bf16(bfloat noundef returned %v) {{.*}} {
...
// CHECK64: define noundef <4 x bfloat> @test_ret_bf16x4_t(<4 x bfloat> noundef returned %v) {{.*}} {
