...
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m1(i32 noundef [[TMP0]])
...
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m1(i32 noundef [[CONV]])
...
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m2(i64 noundef [[CONV]])
...
// CHECK-NEXT:    store i64 [[A:%.*]], i64* [[A_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, i64* [[A_ADDR]], align 8
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m2(i64 noundef [[TMP0]])
...
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m3(i64 noundef [[TMP6]], i64 noundef [[TMP8]])
...
// CHECK-NEXT:    [[CALL:%.*]] = call noundef i32* @m4(i64 noundef [[TMP6]], i64 noundef [[TMP8]], i64 noundef [[TMP11]], i64 noundef [[TMP13]])
// CHECK-NEXT:    [[ALIGNMENTCAST:%.*]] = trunc i128 [[TMP3]] to i64
// CHECK-NEXT:    [[MASK:%.*]] = sub i64 [[ALIGNMENTCAST]], 1
// CHECK-NEXT:    [[PTRINT:%.*]] = ptrtoint i32* [[CALL]] to i64
// CHECK-NEXT:    [[MASKEDPTR:%.*]] = and i64 [[PTRINT]], [[MASK]]
