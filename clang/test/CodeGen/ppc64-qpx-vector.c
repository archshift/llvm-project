...
// ALL-LABEL: define <4 x float> @foo1(<4 x float> inreg %a.coerce, <4 x float> noundef %b, [2 x i128] %c.coerce)
// ALL: ret <4 x float>
...
// QPX-LABEL: define <4 x double> @foo2(<4 x double> inreg %a.coerce, <4 x double> noundef %b, [2 x i256] %c.coerce)
// QPX: ret <4 x double>
