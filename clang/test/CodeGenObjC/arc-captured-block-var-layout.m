...
// Test 1
// Inline instruction for block variable layout: 0x0320 (3 2 byref strong)
...
// Test 2
// Inline instruction for block variable layout: 0x0331 (3 1 3 byref strong weak)
...
void g() {
  ...
  NSString *y;
  NSString *z;
// Inline instruction for block variable layout: 0x0401 (4 0 1 byref strong weak)
