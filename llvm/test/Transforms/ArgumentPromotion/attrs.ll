...
; CHECK-SAME: (i32 partialinit [[B_0:%.*]], i64 partialinit [[B_1:%.*]], i32* byval [[X:%.*]], i32 [[I:%.*]])
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @f(i32 partialinit [[S_0_VAL]], i64 partialinit [[S_1_VAL]], i32* byval [[X]], i32 zeroext 0)
